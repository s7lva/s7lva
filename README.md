...
* **Foco Atual:** 🎯 Especialização em **Linguagem C** e aprofundamento em **Lógica de Programação**, Algoritmos e **Programação Orientada a Objetos (POO)**.
* **Futuro:** 🚀 Pretendo trabalhar com **Robótica e Sistemas de Automação**.
